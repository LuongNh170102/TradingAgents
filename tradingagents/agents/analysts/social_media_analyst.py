"""Social media analyst — analyzes retail investor sentiment from Reddit and macro market mood.

This analyst uses actual social media data (Reddit posts from investing subreddits)
and macro sentiment indicators (CNN Fear & Greed Index) to gauge retail investor
sentiment and overall market mood.

For news-based sentiment analysis, see ``sentiment_analyst`` which analyzes the tone
and sentiment of recent news articles.
"""
...
def create_social_media_analyst(llm):
    """Create a social media analyst node for the trading graph.

    This analyst monitors retail investor sentiment through Reddit discussions
    and contextualizes it with macro market mood indicators.
    """
    ...
    def social_media_analyst_node(state):
        ...
        system_message = (
            "You are a Social Media Sentiment Analyst. Your job is to gauge retail investor sentiment "
